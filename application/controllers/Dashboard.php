...
class Dashboard extends CI_Controller
{
 ...
 public function updateUser(){
  print_r($_POST);
  $data = $this->CoolAdmin_model->updateUser($_POST['id'],$_POST['email'],$_POST['supplier'],$_POST['contact'],$_POST['city'],$_POST['country'], $_POST['state'], $_POST['postalcode'], $_POST['requirements'], $_POST['Address']);
  return $data;
