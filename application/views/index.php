                    ...
                    <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            ...
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                <li class="lvl1 parent megamenu"><a href="#">Test <i class="anm anm-angle-down-l"></i></a>
                                    <div class="megamenu style1">
                                        <ul class="grid mmWrapper">
                                            <li class="grid__item large-up--one-whole">
                                                <ul class="grid">
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Test </a>
                                                        <ul class="subLinks">
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Packages</a>
                                                        <ul class="subLinks">
                                                    ...
                                                    <!-- <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">New Test / Packages</a>
                                                        <ul class="subLinks">
                                ...
                                <li class="lvl1 parent megamenu"><a href="#">Packages <i class="anm anm-angle-down-l"></i></a>
                    ...
                    <div class="collection-grid">
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/product-images/product-image15-1.jpg" src="assets/images/product-images/product-image15-1.jpg" alt="Fashion" class="blur-up lazyload" />
