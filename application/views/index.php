...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/images/Forward.png" />
    <!-- Plugins CSS -->
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="www.Forwardsports.com">
                            <img src="assets/images/frwdlogo.jpg" width="100" alt="Forward Sports Pvt Ltd." title="Forward Sports Pvt Ltd." />
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                                                            ...
                                                            foreach ($getData as $keys) {
                                                                if ($keys['TestType'] == 'Test') {
                                                                    if ($keys['Type'] == 'Balls') {
                                                                        $Name = $keys['Name'];
                                                            ?>
                                                                        <li class="lvl-2"><a href="index.html" class="site-nav lvl-2"><?php echo $Name; ?></a></li>
                                                            <?php
                                                                    }
                                                                }
                                                            }
            ...
            <div class="home-slideshow">
                <div class="slide">
                    <div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/belle-banner1.jpg" src="assets/images/slideshow-banners/belle-banner1.jpg" alt="Looking Forward to Quality" title="Looking Forward to Quality" />
                ...
                <div class="slide">
                    <div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/belle-banner2.jpg" src="assets/images/slideshow-banners/belle-banner2.jpg" alt="Looking Forward to Quality" title="Looking Forward to Quality" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                                    ...
                                                    <div class="col-12 item">
                                                        ...
                                                        <div class="product-image">
                                                            ...
                                                            <a href="short-description.html">
                                                                ...
                                                                <!-- End image -->
                                                                <!-- Hover image -->
                                                                <img class="hover blur-up lazyload" data-src="../sportsassets/img/img/<?php echo  $image; ?>" src="../sportsassets/img/img/<?php echo  $image; ?>" alt="image" title="product">
                                                                <!-- End hover image -->
                                                                <!-- product label -->
                            ...
                            <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-accordion.html"><?php echo $Name; ?></a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
