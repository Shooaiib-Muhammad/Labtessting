    ...
    <br>
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Customer Service Report</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
        ...
        <div class="container w-50 h-50 mt-5">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <span class="d-flex justify-content-end text-end"><b>*Mandatory Fields</b></span>
                </div>
            </div>
        ...
        <div class="container w-50 h-50 mt-5">
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <span><b>Section 2 Detail of Test Report Receiver</b></span>
                </div>
            </div>

            <div class="row mt-3 border border-dark">
                <div class="col-md-3 border border-dark">
                    <span>*Name of receipient:</span>
                </div>
                <div class="col-md-3 border border-dark">
                <?php echo $CSR[0]['Name_of_recipient']; ?>
                </div>
                <div class="col-md-3 border border-dark">
                    <span>*Email ID of receipient:</span>
                </div>
                <div class="col-md-3 border border-dark">
...
<script>
    ...
    location.href = `<?php echo base_url(); ?>CoolAdmin/CSRFilteration`;
    });
